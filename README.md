...
## Phase 2: Essay Assessment Dataset and Prompt Design

Phase 2 produces a small, curated assessment dataset for experimenting with automated evaluation of Brazilian Portuguese entrance-exam essays.
...
- Initial test materials in `tests/`, containing sample assessment outputs generated by different AI assistants for selected essays.
...
Phase 2 therefore establishes the first controlled benchmark for comparing human-assigned essay scores with AI-generated assessments. Later phases can build on this material to run larger-scale evaluation experiments, compare model outputs, analyze scoring consistency, and refine the assessment workflow.
